...
const Work = () => {
  ...
  return (
    <div className="SampleBox">
      ...
      <iframe className="Sample" type="text/html" src="http://www.hookd.dev/" title="HOOKD"></iframe>
      <a href="www.hood.dev">Hookd</a> is a web-app, npm module, and CLI tool for transforming React components. 
