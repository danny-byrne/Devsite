    ...
    <div className="App">
      <div className="Headline">
        ...
        <div className="NavContainer">
          <div className="NavButton" value="about" onClick={(e) => switchView(e, "about")}>About Me</div>
          <div className="NavButton" value="work" onClick={(e) => switchView(e, "work")}>Work</div>
          <div className="NavButton" value="musician" onClick={(e) => switchView(e, "musician")}>Musician</div>
        </div>
...
const About = () => {
  ...
  let text=`Danny Byrne is a software developer, musician, and ceremonialist`;
...
const Work = () => {
  ...
  return (
    <div className="SampleBox">
      ...
      It was developed using Babel, Typescript, and React. My particular role in this developer tool was creating and algorithm
